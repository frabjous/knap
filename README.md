...
* [Invocation and Usage](#markdown-header-invocation-and-usage)
* [Configuring Routines](#markdown-header-configuring-routines)
* [Settings for SyncTeX or other "Jumps"](#markdown-header-settings-for-synctex-or-other-jumps)
* [Delay Setting / Speed Tuning](#markdown-header-delay-setting-speed-tuning)
* [Errors During Processing](#markdown-header-errors-during-processing)
* [Default Configuration](#markdown-header-default-configuration)
* [Setting a Different Root Document](#markdown-header-setting-a-different-root-document)
* [Buffer-Specific Settings / XeLaTeX Detection Example](#markdown-header-buffer-specific-settings-xelatex-detection-example)
* [Configuration Hints for PDF Viewers](#markdown-header-configuration-hints-for-pdf-viewers)
    - [Sioyek (recommended viewer)](#markdown-header-sioyek-recommended-viewer)
    - [llpp](#markdown-header-llpp)
    - [MuPDF](#markdown-header-mupdf)
    - [QpdfView](#markdown-header-qpdfview)
    - [Zathura](#markdown-header-zathura)
    - [Okular](#markdown-header-okular)
    - [apvlv](#markdown-header-apvlv)
    - [Evince (aka GNOME Document Viewer)](#markdown-header-evince-aka-gnome-document-viewer)
* [Configuration Hints for HTML Output / Browsers](#markdown-header-configuration-hints-for-html-output-browsers)
    - [Falkon](#markdown-header-falkon-recommended-browser)
    - [QuteBrowser](#markdown-header-qutebrowser)
    - [Firefox, Chrome, Chromium, etc.](#markdown-header-firefox-chrome-chromium-etc)
